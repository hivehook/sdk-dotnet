...
public sealed class StreamConsumerService : BaseService
{
    ...
    /// <summary>Fetches every page and yields each StreamConsumer as an async stream.</summary>
    public async IAsyncEnumerable<StreamConsumer> ListAllAsync(string streamId, Dictionary<string, object?>? options = null, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
