...
public sealed class BookmarkService : BaseService
{
    ...
    /// <summary>Fetches every page and yields each Bookmark as an async stream.</summary>
    public async IAsyncEnumerable<Bookmark> ListAllAsync(Dictionary<string, object?>? options = null, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
