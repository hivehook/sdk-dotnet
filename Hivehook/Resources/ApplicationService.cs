...
public sealed class ApplicationService : BaseService
{
    ...
    /// <summary>Fetches every page and yields each Application as an async stream.</summary>
    public async IAsyncEnumerable<Application> ListAllAsync(Dictionary<string, object?>? options = null, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
