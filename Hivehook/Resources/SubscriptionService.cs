...
public sealed class SubscriptionService : BaseService
{
    ...
    /// <summary>Fetches every page and yields each Subscription as an async stream.</summary>
    public async IAsyncEnumerable<Subscription> ListAllAsync(Dictionary<string, object?>? options = null, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
