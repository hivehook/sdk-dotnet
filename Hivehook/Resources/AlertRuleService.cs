...
public sealed class AlertRuleService : BaseService
{
    ...
    /// <summary>Fetches every page and yields each AlertRule as an async stream.</summary>
    public async IAsyncEnumerable<AlertRule> ListAllAsync(Dictionary<string, object?>? options = null, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
